...
<head>
  ...
  <!-- Favicons -->
  <link href="image//emb.png" rel="icon">
    ...
    <div id="heroCarousel" data-bs-interval="5000" class="container carousel carousel-fade" data-bs-ride="carousel">
      ...
      <div class="carousel-item active">
        <div class="carousel-container">
          <h2 class="animate__animated animate__fadeInDown">Welcome to Voting Portal</h2>
          <p class="animate__animated fanimate__adeInUp">Your voices are being heard and you are proving to our ancestors that their struggles were not in vain. Now we have one more thing we need to do to walk in our true power, and that is to vote.</p>
          </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
        	<img alt="" src="image//slide1.jpg" width="1120" height="400">
        </div>
      </div>
      ...
      <div class="carousel-item">
        <div class="carousel-container">
        	<img alt="" src="image//slide2.jpg" width="1120" height="400">
        </div>
      </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 mt-4 mt-lg-0">
            <div class="box featured" data-aos="zoom-in" data-aos-delay="300">
              <h3>Step 4 : Wait for Result's</h3>
              <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
                <li>Nulla at volutpat dola</li>
